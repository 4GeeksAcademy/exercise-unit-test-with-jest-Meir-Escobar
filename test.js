...
test ('adds 14 + 9 to equal 23', () => {
    //Dentro de la prueba llamamos a nuestra funcion sum
    let total = sum (14,9);
...
test("One euro should be 156.5 Yens", function() {
    ...
    // Si 1 euro son 156.5 yenes, entonces 3.5 euros debe ser (3.5 * 1.07)
...
test("One euro should be 0.87 Pounds", function() {
    ...
    // Hago mi comparación (la prueba)
    expect(fromEuroToPound(3.5)).toBe(3.045); // Funciona sin colocar el resultado.
